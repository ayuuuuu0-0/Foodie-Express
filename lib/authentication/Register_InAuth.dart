...
import 'package:sellers_app/Widgets/error_dialogue.dart';
import 'package:sellers_app/Widgets/loading_dialogue.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  TextEditingController confirmPaaswordcontroller = TextEditingController();
  ...
  Future<void> formValidation() async
  {
    if (imageXFile == null) {
      ...
      if (passwordcontroller.text == confirmPaaswordcontroller.text) {
        //start uploading image

        if (confirmPaaswordcontroller.text.isNotEmpty
  ...
  Future saveDataToFirestore(User currentUser) async{
    ...
    await sharedPreferences!.setString("names", namecontroller.text.trim());
            ...
            Form(
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    data: Icons.lock,
                    controller: confirmPaaswordcontroller,
